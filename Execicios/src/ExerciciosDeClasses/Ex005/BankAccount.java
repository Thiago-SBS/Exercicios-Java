...
public class BankAccount {
    ...
    public BankAccount() {
        this.setAccountBalance((double)0.0F);
    ...
    public void openAccount(String type) {
        ...
        if (type.equals("CC")) {
            this.setAccountBalance((double)50.0F);
        } else if (type.equals("CP")) {
            this.setAccountBalance((double)150.0F);
        }
    ...
    public void payMonthly() {
        ...
        if (this.getAccountStatus()) {
            if (this.getAccountBalance() > (double)value) {
                this.setAccountBalance(this.getAccountBalance() - (double)value);
